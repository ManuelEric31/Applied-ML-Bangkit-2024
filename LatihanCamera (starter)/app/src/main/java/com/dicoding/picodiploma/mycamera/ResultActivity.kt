...
//                        Pastikan memanggil fungsi close() ketika object Translator sudah tidak digunakan lagi.
//                        Karena alasan yang sama, di akhir kode kita menambahkan translator ke dalam observer lifecycle
//                         Hal ini berguna supaya object Translator
//                         bisa dihapus ketika memasuki state onPause(), onStop(), dan onDestroy().
